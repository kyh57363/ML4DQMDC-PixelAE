**Notebooks corresponding to source classes**

The notebooks in this folder are deprecated and should not be used anymore.  
They are fully equivalent to the regular python files one directory above and its subdirectories (on November 9, 2021).  
